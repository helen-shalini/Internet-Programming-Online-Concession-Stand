            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span>Choose your food</li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span>Add to cart</li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span>Order and Pay online</li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
