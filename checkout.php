        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html">Crave Hub </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span>Choose your dish</li>
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span>Add to cart</li>
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span>Order and Pay online</li>
                    </ul>
                </div>
            </div>
